/**
 * Fan card stack — cards fan out in a 3D arc; the active card sits centered,
 * lifted and scaled. Click a card / drag the active card / arrow keys / dots
 * to navigate. Vendored from the user-supplied 21st.dev @ruixen.ui/card-stack
 * source, adapted for this app: no "use client"/next/link (Vite SPA, plain
 * <a>), cn from @/lib/utils, dot colors on explicit palette (the project's
 * `foreground` token has no <alpha-value>, so opacity modifiers won't work).
 */
import * as React from "react";
import { motion, AnimatePresence, useReducedMotion, type PanInfo } from "framer-motion";
import { SquareArrowOutUpRight } from "lucide-react";

// Local join (as in the source component) — avoids pulling tailwind-merge
// into the landing chunk for simple class concatenation.
                ...
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ...
                      : "bg-slate-400/40 hover:bg-slate-400/70 dark:bg-slate-600 dark:hover:bg-slate-500",
                  )}
